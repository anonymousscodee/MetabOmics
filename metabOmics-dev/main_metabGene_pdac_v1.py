...
if __name__ == "__main__":
    ...
    # Read data
    X_breast, y_breast = SkUtilsIO("../Omic_Network_Construction/Dataset/metabData_pdac.csv").from_csv(label_column='Factors')
    X_tr, y_tr = SkUtilsIO("../Omic_Network_Construction/Dataset/geneData_pdac.csv").from_csv(label_column='Factors')
    ...
    dosya_adi = "output_pdac_v1_org.txt"
    count = 1
    ...
    with open(dosya_adi, 'w') as json_file:
        ...
        for train_index, test_index in skf.split(X_breast, y_breast):
            try :
                ...
                print(count, "-fold v1 pdac org, test_score : ", test_score)
                ...
                break
    with open('scores_pdac_v1_org.txt', 'w') as f:
        try:
