...
import sys
import numpy as np
sys.path.append(r'../Omic_Network_Construction')
...
class MetaboliticsAnalysis:
    ...
    def variability_analysis(self, measured_metabolites, x_tr):
        ...
        with open('../Omic_Network_Construction/universalGraph_new.json', 'r') as file:
            data = json.load(file)
        G = Graph()
        with open('../Omic_Network_Construction/labelGraph_new.json', 'r') as json_file:
        ...
        for edge in data['edges']:
            G.add_edge(start_id=edge['start_vertex'], end_id=edge['end_vertex'], weight=edge['weight'], int_info=edge['int_info'])
